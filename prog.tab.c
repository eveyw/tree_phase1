...
/* Tokens.  */
#define TOK_MAIN 258
#define TOK_SEMICOLON 259
#define TOK_ADD 260
#define TOK_SUB 261
#define TOK_MUL 262
#define TOK_DIV 263
#define TOK_NUM 264
#define TOK_PRINTLN 265
...
{
  "$end", "error", "$undefined", "TOK_MAIN", "TOK_SEMICOLON", "TOK_ADD",
  "TOK_SUB", "TOK_MUL", "TOK_DIV", "TOK_NUM", "TOK_PRINTLN", "TOK_FLOAT",
  "'('", "')'", "$accept", "Prog", "Stmts", 0
};
#endif
